...
The distinction between *fixed* and *random* effects in linear mixed effect models allows for modeling of both between-subject and within-subject variations.
