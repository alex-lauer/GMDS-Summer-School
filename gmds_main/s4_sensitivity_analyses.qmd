...
-   pool() - combines the results across imputed data sets, for method_bayes (see above) inference is based on Rubin's rule
...
Table: Adjusted means for the complete case data set
