...
-   Look the MMRM and at the complete case (CC) analysis again (from section missingness).
...
Include code so that the participants have the correct set-up

## Solution for the practical part
### 1. Complete case
```{r}
